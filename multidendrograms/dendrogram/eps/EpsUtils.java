...
public class EpsUtils {
	...
	public EpsUtils(int x0, int y0, int x1, int y1) {
		xmin = x0;
		ymin = y0;
		xmax = x1;
		ymax = y1;
	...
	public static void open(String epsPath) {
		try {
			epsFullFileName = epsPath;
	...
	public static void close() {
		try {
			...
			String msg = Language.getLabel(108) + epsFullFileName;
			JOptionPane.showMessageDialog(null, msg, "Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public static void writeComments(String creator, String orientation) {
		...
		writeLine("%%Creator: " + Main.PROGRAM + " " + Main.VERSION + "  " + Main.HOMEPAGE_URL + "");
		writeLine("%%CreationDate: " + sdf.format(cal.getTime()));
	...
	public static void writeProlog(String prolog_path) {
		try {
			...
			String msg = Language.getLabel(109) + epsFullFileName;
			JOptionPane.showMessageDialog(null, msg, "Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}
